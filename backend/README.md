...
## Project Structure
    ...
    ├── testapiautoteammemb_61912  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_61912`
...
2. Clone this repo and `cd testapiautoteammemb_61912`
